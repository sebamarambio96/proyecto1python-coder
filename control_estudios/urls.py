...
from control_estudios.views import listar_cursos, crear_cursos, crear_cursos2, buscar_cursos,\
    crear_estudiante, crear_profesor, crear_entregable, eliminar_curso, editar_curso, EstudianteListView, EstudianteCreateView,\
